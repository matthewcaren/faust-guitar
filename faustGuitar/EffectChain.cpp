...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "EffectChain.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::exp((0.0f - (25.0f / fConst0)));
		fConst2 = (1.0f - fConst1);
		fConst3 = std::exp((0.0f - (12.5f / fConst0)));
		fConst4 = std::exp((0.0f - (3.33333325f / fConst0)));
		fConst5 = std::exp((0.0f - (3141.59277f / fConst0)));
		fConst6 = mydsp_faustpower2_f(fConst5);
		fConst7 = (0.0f - (2.0f * fConst5));
		fConst8 = (1.25f / fConst0);
		fConst9 = (6.28318548f / fConst0);
		fConst10 = (1.5625f / fConst0);
		fConst11 = (9424.77832f / fConst0);
		fConst12 = ((1.0f - fConst11) / (fConst11 + 1.0f));
		fConst13 = (1979.20337f / fConst0);
		fConst14 = ((1.0f - fConst13) / (fConst13 + 1.0f));
		...
		fConst18 = (0.833333313f * fConst17);
		fConst19 = (1.0f / std::tan((628.318542f / fConst0)));
		fConst20 = (1.0f / (fConst19 + 1.0f));
		fConst21 = (1.0f - fConst19);
		fConst22 = std::floor(((0.0273330007f * fConst0) + 0.5f));
		iConst23 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst16 - fConst22))));
		iConst24 = int(std::min<float>(50.0f, std::max<float>(0.0f, (0.0500000007f * fConst0))));
		...
		fConst28 = (0.833333313f * fConst27);
		fConst29 = std::floor(((0.0244210009f * fConst0) + 0.5f));
		iConst30 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst26 - fConst29))));
		...
		fConst34 = (0.833333313f * fConst33);
		fConst35 = std::floor(((0.0316039994f * fConst0) + 0.5f));
		iConst36 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst32 - fConst35))));
		...
		fConst40 = (0.833333313f * fConst39);
		fConst41 = std::floor(((0.0203460008f * fConst0) + 0.5f));
		iConst42 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst38 - fConst41))));
		iConst43 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst41 + -1.0f))));
		fConst44 = (0.0f - (std::cos(fConst13) * (fConst14 + 1.0f)));
		fConst45 = (0.0f - (std::cos(fConst11) * (fConst12 + 1.0f)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("EffectChain");
		ui_interface->addHorizontalSlider("compressorDepth", &fHslider3, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("compressorParam", &fHslider4, 6.0f, 1.0f, 20.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("fuzzDepth", &fHslider1, 0.0f, 0.0f, 0.300000012f, 0.00100000005f);
		ui_interface->addHorizontalSlider("fuzzParam", &fHslider5, 0.0f, 0.0f, 1.20000005f, 0.00999999978f);
		ui_interface->addHorizontalSlider("phaserDepth", &fHslider2, 1.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("phaserParam", &fHslider6, 0.400000006f, 0.0f, 7.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("reverbDepth", &fHslider0, 0.400000006f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("reverbParam", &fHslider7, 15.0f, 1.0f, 45.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (1.0f - (2.5f * fSlow1));
		float fSlow3 = float(fHslider2);
		float fSlow4 = (fSlow2 * (1.0f - (0.5f * fSlow3)));
		float fSlow5 = float(fHslider3);
		float fSlow6 = (fSlow5 + 1.0f);
		float fSlow7 = ((1.0f - fSlow1) * fSlow6);
		float fSlow8 = (1.0f - fSlow5);
		float fSlow9 = (fConst2 * ((1.0f / float(fHslider4)) + -1.0f));
		float fSlow10 = (std::pow(10.0f, (2.0f * float(fHslider5))) * fSlow6);
		float fSlow11 = (0.5f * fSlow2);
		float fSlow12 = (fConst9 * float(fHslider6));
		float fSlow13 = std::sin(fSlow12);
		float fSlow14 = std::cos(fSlow12);
		float fSlow15 = (1.0f - (0.5f * fSlow0));
		float fSlow16 = float(fHslider7);
		float fSlow17 = std::exp((fConst17 / fSlow16));
		...
		float fSlow22 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow19) / mydsp_faustpower2_f(fSlow20)) + -1.0f)));
		float fSlow23 = (fSlow21 - fSlow22);
		float fSlow24 = (fSlow17 * (fSlow22 + (1.0f - fSlow21)));
		float fSlow25 = ((std::exp((fConst18 / fSlow16)) / fSlow17) + -1.0f);
		float fSlow26 = std::exp((fConst27 / fSlow16));
		float fSlow27 = mydsp_faustpower2_f(fSlow26);
		float fSlow28 = (1.0f - (fConst15 * fSlow27));
		...
		float fSlow34 = ((std::exp((fConst28 / fSlow16)) / fSlow26) + -1.0f);
		float fSlow35 = std::exp((fConst33 / fSlow16));
		float fSlow36 = mydsp_faustpower2_f(fSlow35);
		float fSlow37 = (1.0f - (fConst15 * fSlow36));
		...
		float fSlow43 = ((std::exp((fConst34 / fSlow16)) / fSlow35) + -1.0f);
		float fSlow44 = std::exp((fConst39 / fSlow16));
		float fSlow45 = mydsp_faustpower2_f(fSlow44);
		float fSlow46 = (1.0f - (fConst15 * fSlow45));
		...
		float fSlow52 = ((std::exp((fConst40 / fSlow16)) / fSlow44) + -1.0f);
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			iVec0[0] = 1;
			float fTemp1 = std::fabs((fSlow6 * fTemp0));
			float fTemp2 = ((fRec1[1] > fTemp1) ? fConst4 : fConst3);
			fRec2[0] = ((fRec2[1] * fTemp2) + (fTemp1 * (1.0f - fTemp2)));
			fRec1[0] = fRec2[0];
			fRec0[0] = ((fConst1 * fRec0[1]) + (fSlow9 * std::max<float>((20.0f * (std::log10(fRec1[0]) + 1.0f)), 0.0f)));
			float fTemp3 = (fTemp0 * (fSlow8 + (fSlow5 * std::pow(10.0f, (0.0500000007f * fRec0[0])))));
			float fTemp4 = std::max<float>(-1.0f, std::min<float>(1.0f, ((fSlow10 * fTemp3) + 0.100000001f)));
			float fTemp5 = ((fSlow7 * fTemp3) + (fSlow1 * (fTemp4 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp4))))));
			fRec6[0] = ((fSlow13 * fRec7[1]) + (fSlow14 * fRec6[1]));
			fRec7[0] = ((float((1 - iVec0[1])) + (fSlow14 * fRec7[1])) - (fSlow13 * fRec6[1]));
			float fTemp6 = ((2984.51294f * (1.0f - fRec6[0])) + 314.159271f);
			float fTemp7 = (fRec5[1] * std::cos((fConst8 * fTemp6)));
			fRec5[0] = (((fSlow11 * fTemp5) + (0.400000006f * fRec3[1])) - ((fConst7 * fTemp7) + (fConst6 * fRec5[2])));
			float fTemp8 = (fRec4[1] * std::cos((fConst10 * fTemp6)));
			fRec4[0] = ((fConst7 * (fTemp7 - fTemp8)) + (fRec5[2] + (fConst6 * (fRec5[0] - fRec4[2]))));
			fRec3[0] = ((fConst6 * fRec4[0]) + ((fConst7 * fTemp8) + fRec4[2]));
			float fTemp9 = ((fSlow4 * fTemp5) + (fSlow3 * fRec3[0]));
			fVec1[(IOTA & 63)] = fTemp9;
			fRec17[0] = (0.0f - (fConst20 * ((fConst21 * fRec17[1]) - (fRec13[1] + fRec13[2]))));
			fRec16[0] = ((fSlow23 * fRec16[1]) + (fSlow24 * (fRec13[1] + (fSlow25 * fRec17[0]))));
			fVec2[(IOTA & 2047)] = ((0.5f * fRec16[0]) + 9.99999968e-21f);
			float fTemp10 = (0.150000006f * fVec1[((IOTA - iConst24) & 63)]);
			float fTemp11 = (((0.600000024f * fRec14[1]) + fVec2[((IOTA - iConst23) & 2047)]) - fTemp10);
			fVec3[(IOTA & 4095)] = fTemp11;
			fRec14[0] = fVec3[((IOTA - iConst25) & 4095)];
			float fRec15 = (0.0f - (0.600000024f * fTemp11));
			fRec21[0] = (0.0f - (fConst20 * ((fConst21 * fRec21[1]) - (fRec11[1] + fRec11[2]))));
			fRec20[0] = ((fSlow32 * fRec20[1]) + (fSlow33 * (fRec11[1] + (fSlow34 * fRec21[0]))));
			fVec4[(IOTA & 2047)] = ((0.5f * fRec20[0]) + 9.99999968e-21f);
			float fTemp12 = (fVec4[((IOTA - iConst30) & 2047)] + (fTemp10 + (0.600000024f * fRec18[1])));
			fVec5[(IOTA & 4095)] = fTemp12;
			fRec18[0] = fVec5[((IOTA - iConst31) & 4095)];
			float fRec19 = (0.0f - (0.600000024f * fTemp12));
			fRec25[0] = (0.0f - (fConst20 * ((fConst21 * fRec25[1]) - (fRec12[1] + fRec12[2]))));
			fRec24[0] = ((fSlow41 * fRec24[1]) + (fSlow42 * (fRec12[1] + (fSlow43 * fRec25[0]))));
			fVec6[(IOTA & 2047)] = ((0.5f * fRec24[0]) + 9.99999968e-21f);
			float fTemp13 = (fVec6[((IOTA - iConst36) & 2047)] - (fTemp10 + (0.600000024f * fRec22[1])));
			fVec7[(IOTA & 4095)] = fTemp13;
			fRec22[0] = fVec7[((IOTA - iConst37) & 4095)];
			float fRec23 = (0.600000024f * fTemp13);
			fRec29[0] = (0.0f - (fConst20 * ((fConst21 * fRec29[1]) - (fRec10[1] + fRec10[2]))));
			fRec28[0] = ((fSlow50 * fRec28[1]) + (fSlow51 * (fRec10[1] + (fSlow52 * fRec29[0]))));
			fVec8[(IOTA & 2047)] = ((0.5f * fRec28[0]) + 9.99999968e-21f);
			float fTemp14 = ((fVec8[((IOTA - iConst42) & 2047)] + fTemp10) - (0.600000024f * fRec26[1]));
			fVec9[(IOTA & 2047)] = fTemp14;
			fRec26[0] = fVec9[((IOTA - iConst43) & 2047)];
			float fRec27 = (0.600000024f * fTemp14);
			float fTemp15 = (fRec27 + fRec23);
			fRec10[0] = (fRec14[1] + (fRec18[1] + (fRec22[1] + (fRec26[1] + (fRec15 + (fRec19 + fTemp15))))));
			fRec11[0] = ((fRec22[1] + (fRec26[1] + fTemp15)) - (fRec14[1] + (fRec18[1] + (fRec19 + fRec15))));
			fRec12[0] = ((fRec18[1] + (fRec26[1] + (fRec27 + fRec19))) - (fRec14[1] + (fRec22[1] + (fRec23 + fRec15))));
			fRec13[0] = ((fRec14[1] + (fRec26[1] + (fRec27 + fRec15))) - (fRec18[1] + (fRec22[1] + (fRec23 + fRec19))));
			float fTemp16 = (0.370000005f * (fRec11[0] + fRec12[0]));
			float fTemp17 = (fConst44 * fRec9[1]);
			fRec9[0] = (fTemp16 - (fTemp17 + (fConst14 * fRec9[2])));
			float fTemp18 = (fConst14 * fRec9[0]);
			float fTemp19 = (0.5f * ((fTemp18 + (fRec9[2] + (fTemp16 + fTemp17))) + ((fTemp18 + (fTemp17 + fRec9[2])) - fTemp16)));
			float fTemp20 = (fConst45 * fRec8[1]);
			fRec8[0] = (fTemp19 - (fTemp20 + (fConst12 * fRec8[2])));
			float fTemp21 = (fConst12 * fRec8[0]);
			float fTemp22 = (0.370000005f * (fRec11[0] - fRec12[0]));
			float fTemp23 = (fConst44 * fRec31[1]);
			fRec31[0] = (fTemp22 - (fTemp23 + (fConst14 * fRec31[2])));
			float fTemp24 = (fConst14 * fRec31[0]);
			float fTemp25 = (0.5f * ((fTemp24 + (fRec31[2] + (fTemp22 + fTemp23))) + ((fTemp24 + (fTemp23 + fRec31[2])) - fTemp22)));
			float fTemp26 = (fConst45 * fRec30[1]);
			fRec30[0] = (fTemp25 - (fTemp26 + (fConst12 * fRec30[2])));
			float fTemp27 = (fConst12 * fRec30[0]);
			output0[i] = FAUSTFLOAT((0.5f * ((fSlow0 * fTemp9) + (fSlow15 * (((fTemp21 + (fRec8[2] + (fTemp19 + fTemp20))) + ((fTemp21 + (fTemp20 + fRec8[2])) - fTemp19)) + ((fTemp27 + (fRec30[2] + (fTemp25 + fTemp26))) + ((fTemp27 + (fTemp26 + fRec30[2])) - fTemp25)))))));
			iVec0[1] = iVec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
...
EffectChain::EffectChain() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void EffectChain::setParamValue(const std::string& path, float value)
{
